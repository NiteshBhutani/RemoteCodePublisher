...
int main(int argc, char* argv[])
{
  ...
  */
  ...
  currfiles = Directory::getFiles("C:\\Users\\Nitesh\\Downloads\\Code - 01 - AdvancedAuthentication Round 1\\AdvancedAuthentication", "*.cs");
  std::string myFile = "C:\\Users\\Nitesh\\Downloads\\Code - 01 - AdvancedAuthentication Round 1\\AdvancedAuthentication";
  ...
  Directory::setCurrentDirectory(myFile);
  for(size_t i=0; i<currfiles.size(); ++i)
  ...
  File me("TestFileSystem/FileSystemTest.cpp");
