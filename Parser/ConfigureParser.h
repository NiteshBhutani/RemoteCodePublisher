...
namespace CodeAnalysis
{
  ...
  private:
	...
	/*Nitesh Code*/
	CppTypedefDefinition* pTypedefDefination = nullptr; //action
	HandleTypedefDefinition* pHandleTypedefDefination = nullptr;//rule

	CppEnumDefinition* pEnumDefination = nullptr;
	HandleEnumDefinition* pHandleEnumDefination = nullptr;
	
	CppAliasDefinition* pAliasDefination = nullptr;
	HandleAliasDefination* pHandleAliasDefination = nullptr;
	/*******/
