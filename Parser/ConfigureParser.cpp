...
Parser* ConfigParseForCodeAnal::Build()
{
  try
  {
	...
	//Enum
	pEnumDefination = new CppEnumDefinition;
	pHandleEnumDefination = new HandleEnumDefinition(pRepo); // action
	pEnumDefination->addAction(pHandleEnumDefination);
	pParser->addRule(pEnumDefination);
	//typedef
	pTypedefDefination = new CppTypedefDefinition;
	pHandleTypedefDefination = new HandleTypedefDefinition(pRepo); // action
	pTypedefDefination->addAction(pHandleTypedefDefination);
	pParser->addRule(pTypedefDefination);
	//alias
	pAliasDefination = new CppAliasDefinition;
	pHandleAliasDefination = new HandleAliasDefination(pRepo);
