//////////////////////////////////////////////////////////////////////
// TypeTable.cpp - Package to define the data structure that will	//
...
/*********<<	// Function to add record into TypeTable	>>*******************/
...
/*********<< Fucntion to show single record in type table >>*******************/
...
/*********<< Function to access single record/typeinfo/Type in typetable - Read/Write Access >>*******************/
...
/*********<< Function to access single record/typeinfo/Type in typetable - Read Access >>*******************/
...
/*********<< Function to find all the types based on Type Name >>*******************/
...
/*********<< Function to find all the types based on Type >>*******************/
...
void split(const std::string& s, std::string c,	std::vector<std::string>& v) {
...
/*********<< Function to find all the types based on Type Namespace	>>*******************/
...
/*********<<Function to find all the types based on Type location>>*******************/
...
/*********<< Function to check whether FQN of Type contain particular namespace - If yes return location >>*******************/
